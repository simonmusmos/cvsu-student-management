...
@section('content')
    <div class="card mt-4">
        <div class="card-body">
            ...
            <form id="create" method="POST" action="{{ route('students.add') }}">
            @csrf
                <div class="m-4 row">
                    <!-- Grid column -->
                    <div class="col-md-7">
                        <div class="form-group">
							...
							<input type="text" id="first_name" value="{{ old('first_name') ?? '' }}" name="first_name" class="form-control" placeholder="Student First Name">
						</div>
                    </div>
                    <div class="col-md-7">
                        <div class="form-group">
