                ...
                <div class="m-4 row">
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
							...
							<input type="text" id="name" name="name" value="{{ $section->name }}" class="form-control" placeholder="Section Name">
						</div>
                    </div>
                    <div class="col-md-7">
                        <div class="form-group">
							...
							<select id="teacher" name="teacher" class="form-control">
                                ...
                                @foreach($teachers as $teacher)
                                    <option value="{{ $teacher->id }}" {{ @$section->section_teacher->teacher_id == $teacher->id ? 'selected' : '' }}>{{ $teacher->first_name }} {{ $teacher->last_name }}</option>
                                @endforeach
                            </select>
						</div>
                    </div>
